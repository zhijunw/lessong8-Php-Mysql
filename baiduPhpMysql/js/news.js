        ...
        $.ajax({
            ...
            if (data.length==0) {
                ...
                data.forEach(function(value, index, array) {
                    ...
                    var $h2 = $("<h2></h2>").html(value.newstitle).appendTo($contdiv);
                    var $h2p = $("<p></p>").html("新闻内容").appendTo($contdiv);
                    var $share = $("<div></div>").addClass("news-share").appendTo($contdiv);
                    var $time = $("<span></span>").addClass("nesw-share-time").html(value.newstime).appendTo($share);
                    var $sharespan = $("<span></span>").html("分享").appendTo($share);
